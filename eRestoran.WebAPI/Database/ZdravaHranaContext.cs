...
{
    public partial class ZdravaHranaContext : DbContext
    {
        public ZdravaHranaContext()
        {
        }

        public ZdravaHranaContext(DbContextOptions<ZdravaHranaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.;Database=ZdravaHrana;Trusted_Connection=True;");
            }
        }
